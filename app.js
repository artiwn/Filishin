...
function ctaBand(){return '<section class="ctaband"><div class="wrap"><div><h2>Let\'s build<br>the future.</h2><p>Planning a public, commercial, hospitality or residential project? Start the conversation with our team.</p><a class="mail" href="/contact">Start a project →</a></div><div class="side"><div class="r"><div class="k">Head office</div><div class="v">Yerevan, Armenia</div></div><div class="r"><div class="k">Founded</div><div class="v">2005</div></div><div class="r"><div class="k">Coverage</div><div class="v">Nationwide</div></div></div></div></section>';}
...
PAGES["/environment"]=function(){
  ...
  '<section class="blk alt"><div class="wrap">'+shead("Manufacturing base","Two facilities,<br>one supply chain.","The backbone of every Filishin project — turning raw stone into finished structures.")+
    ...
    '<div class="addr rv"><div class="a"><div class="t">Facility 01 · Crushing &amp; Washing</div><h4>Dilijan region</h4><p>Armenia, 3908 · Tavush Marz, Haghartsin village, 1st St., 10th Blind Alley 15</p></div><div class="a"><div class="t">Facility 02 · Concrete Production</div><h4>Balahovit</h4><p>Armenia, 2213 · Kotayk Marz, Balahovit village, 8th Street</p></div></div>'+
...
PAGES["/contact"]=function(){
  ...
  '<section class="blk"><div class="wrap contact-grid"><div class="cinfo rv"><div class="row"><div class="l">Head office</div><div class="v">Marshal Baghramyan Ave., 3rd Lane,<br>Bldg 4/3, Arabkir · Yerevan 0033, Armenia</div></div><div class="row"><div class="l">Phone</div><div class="v"><a href="tel:+37494288836">+374 94 288836</a></div></div><div class="row"><div class="l">Email</div><div class="v"><a href="mailto:info@filisin.am">info@filisin.am</a></div></div><div class="row"><div class="l">Production — Dilijan</div><div class="v" style="font-size:.98rem">Haghartsin village, Tavush Marz (crushing &amp; washing)</div></div><div class="row"><div class="l">Production — Balahovit</div><div class="v" style="font-size:.98rem">Balahovit village, Kotayk Marz (concrete)</div></div><div class="row"><div class="l">Hours</div><div class="v">Mon–Fri · 09:00–18:00</div></div><div class="row"><div class="l">Coverage</div><div class="v" style="font-size:.98rem">Yerevan · Dilijan · Sevan · Vanadzor · Armavir · Kapan</div></div></div>'+
